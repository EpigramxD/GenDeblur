...
class Population:
    ...
    def fit(self, no_ref_metric_type, ref_metric_type, deconv_type):
        ...
        for individual in self.__individuals:
            ...
            individual.score = ImgQuality.test_map_metric(deblurred_image, self.__blurred) + 1000 * self.__current_psf_size * ImgQuality.get_no_ref_quality(deblurred_image, no_ref_metric_type)
